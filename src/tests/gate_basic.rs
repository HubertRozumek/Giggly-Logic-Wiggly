...
fn test_nesting_gate(){
    ...
    let gate = OrGate::new(a,Rc::new(RefCell::new(NotGate::new(Rc::new(RefCell::new(ConstGate::new(Signal::Low)))))));
    assert_eq!(gate.eval(),Signal::High);  
}
...
fn test_nesting_xor_gate(){
    let a = Rc::new(RefCell::new(ConstGate::new(Signal::Low)));
    let gate = XorGate::new(a,Rc::new(RefCell::new(NotGate::new(Rc::new(RefCell::new(ConstGate::new(Signal::Low)))))));
    assert_eq!(gate.eval(),Signal::High);  
}
...
fn test_nesting_nor_gate(){
    let a = Rc::new(RefCell::new(ConstGate::new(Signal::Low)));
    let gate = NorGate::new(a,Rc::new(RefCell::new(NotGate::new(Rc::new(RefCell::new(ConstGate::new(Signal::High)))))));
    assert_eq!(gate.eval(),Signal::High);  
}
...
//     d.borrow_mut().signal = Signal::High;
//     enable.borrow_mut().signal = Signal::High;
//     assert_eq!(latch.eval(),Signal::High);

//     d.borrow_mut().signal = Signal::Low;
//     enable.borrow_mut().signal = Signal::Low;
//     assert_eq!(latch.eval(),Signal::High);
